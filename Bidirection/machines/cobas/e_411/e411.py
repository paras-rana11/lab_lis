...
MACHINE_NAME = 'Cobas E 411 2'
HOST_ADDRESS = '192.168.3.143'
HOST_PORT = 6040
HOST_COM_PORT = 'COM1'
MACHINE_ID = 'E_411_2'
REPORT_FILE_PREFIX = 'e_411_2_'
CONNECTION_TYPE = 'Serial'

LOG_FILE = 'C:\\ASTM\\root\\log_file\\logging_for_e_411_2_info.log'
ERROR_LOG_FILE = 'C:\\ASTM\\root\\log_file\\logging_for_e_411_2_error.log'
LOG_FILE_LIST = [LOG_FILE, ERROR_LOG_FILE]

SUBJECT = "Email From SGL Hospital(Blood Bamk)"
...
def save_case_to_json(case_entry, machine_id, file_name):
    ...
    try:
        ...
        error_message = 'Error in save case in json'
        send_mail_or_logging(error_message, e)
